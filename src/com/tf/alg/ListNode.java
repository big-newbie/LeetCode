...
//        return ReverseList2(head);
    ...
    public static void main(String[] args) {
        ...
        ListNode listNode = Builder.newBuilder().next(1, 2, 3, 4, 123).build();
        listNode.print();
        System.out.println("===========");
        ListNode reverseList1 = ReverseList1(listNode);
        reverseList1.print();

        ListNode reverseList2 = ReverseList2(ListNode.Builder.newBuilder().next(1).next(2).next(3).next(4).next(5).build());
        reverseList2.print();
...
//        int[] popA = {4, 5, 3, 2, 1};
        ...
        ListNode mergeList = merge2(null, Builder.newBuilder().next(1, 1, 3, 3, 5, 7, 7, 9).build());
        mergeList.print();
    ...
    public static class Builder {
        ...
        public Builder next(ListNode ln) {
            if (head == null) {
                head = ln;
                tail = ln;
