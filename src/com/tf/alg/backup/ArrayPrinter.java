...
public class ArrayPrinter<T> {
    ...
    public static void print(int[][] ints) {
        ...
        new ArrayPrinter<>().print0(integers);
    }

    public static <T> void print(T[][] ts) {
        new ArrayPrinter<T>().print0(ts);
    }
    ...
    public ArrayPrinter(PrintStream out) {
        this(out, DEFAULT_AS_NULL);
    }

    public ArrayPrinter(PrintStream out, String asNull) {
        if (out == null) {
    ...
    private static <T> T safeGet(T[] array, int index, T defaultValue) {
